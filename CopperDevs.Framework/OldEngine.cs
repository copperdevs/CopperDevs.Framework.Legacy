...
public class OldEngine : Singleton<OldEngine>
{
    ...
    public OldEngine() : this(EngineSettings.DefaultSettings)
    {
        
    }

    public OldEngine(EngineSettings settings)
    {
    ...
    private void Start()
    {
        ...
        WindowsApi.OnWindowResize += newSize =>
        {
            Log.Info($"windows size {newSize} | raylib size {EngineWindow.Size}");
            Update();
        };
